...
export const resourceDetailPages = ImmutableMap<GroupVersionKind | string, () => Promise<React.ComponentType<any>>>()
  ...
  .set(referenceForModel(ComponentModel), () => import('../extend/devconsole/components/codebases/codebaselist' /* webpackChunkName: "Component" */).then(m => m.ComponentDetailsPage))
...
export const resourceListPages = ImmutableMap<GroupVersionKind | string, () => Promise<React.ComponentType<any>>>()
  ...
  .set(referenceForModel(ComponentModel), () => import('../extend/devconsole/components/codebases/codebaselist' /* webpackChunkName: "Component" */).then(m => m.ComponentPage))
