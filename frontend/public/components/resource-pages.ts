...
export const resourceDetailPages = ImmutableMap<GroupVersionKind | string, () => Promise<React.ComponentType<any>>>()
  ...
  .set(referenceForModel(ComponentModel), () => import('../extend/devconsole/components/codebases/CodebaseDetailsPage' /* webpackChunkName: "CodebaseDetails" */).then(m => m.default))
...
export const resourceListPages = ImmutableMap<GroupVersionKind | string, () => Promise<React.ComponentType<any>>>()
  ...
  .set(referenceForModel(ComponentModel), () => import('../extend/devconsole/components/codebases/CodebasePage' /* webpackChunkName: "CodebaseList" */).then(m => m.default))
