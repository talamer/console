...
export const resourceDetailPages = ImmutableMap<GroupVersionKind | string, () => Promise<React.ComponentType<any>>>()
  ...
  .set(referenceForModel(ComponentModel), () => import('../extend/devconsole/components/codebases/CodebaseList' /* webpackChunkName: "Component" */).then(m => m.CodebaseDetailsPage))
...
export const resourceListPages = ImmutableMap<GroupVersionKind | string, () => Promise<React.ComponentType<any>>>()
  ...
  .set(referenceForModel(ComponentModel), () => import('../extend/devconsole/components/codebases/CodebaseList' /* webpackChunkName: "Component" */).then(m => m.CodebasePage))
