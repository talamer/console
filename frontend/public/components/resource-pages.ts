...
export const resourceDetailPages = ImmutableMap<GroupVersionKind | string, () => Promise<React.ComponentType<any>>>()
  ...
  .set(referenceForModel(ComponentModel), () => import('../extend/devconsole/components/codebases/CodebaseDetailsPage' /* webpackChunkName: "CodebaseDetailsPage" */).then(m => m.default))
...
export const resourceListPages = ImmutableMap<GroupVersionKind | string, () => Promise<React.ComponentType<any>>>()
  ...
  .set(referenceForModel(ComponentModel), () => import('../extend/devconsole/components/codebases/CodebasePage' /* webpackChunkName: "Component" */).then(m => m.default))
