            ...
            <div id="content">
              ...
              <div id="content-scrollable">
                <Switch>
                  ...
                  <LazyRoute path={this._prependActivePerspective('/settings/idp/github')} exact loader={() => import('./cluster-settings/github-idp-form' /* webpackChunkName: "github-idp-form" */).then(m => m.AddGitHubPage)} />
                  <LazyRoute path={this._prependActivePerspective('/settings/idp/gitlab')} exact loader={() => import('./cluster-settings/gitlab-idp-form' /* webpackChunkName: "gitlab-idp-form" */).then(m => m.AddGitLabPage)} />
                  <LazyRoute path={this._prependActivePerspective('/settings/idp/google')} exact loader={() => import('./cluster-settings/google-idp-form' /* webpackChunkName: "google-idp-form" */).then(m => m.AddGooglePage)} />
                  ...
                  <LazyRoute path={this._prependActivePerspective('/settings/idp/ldap')} exact loader={() => import('./cluster-settings/ldap-idp-form' /* webpackChunkName: "ldap-idp-form" */).then(m => m.AddLDAPPage)} />
                  ...
                  <LazyRoute path={this._prependActivePerspective('/settings/idp/basicauth')} exact loader={() => import('./cluster-settings/basicauth-idp-form' /* webpackChunkName: "basicauth-idp-form" */).then(m => m.AddBasicAuthPage)} />
